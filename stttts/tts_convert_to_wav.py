...
def process_input_ids(generated_ids):
    ...
    stacked_tensor = torch.stack([processed_tensor_content, processed_tensor_content,processed_tensor_content, processed_tensor_content,processed_tensor_content, processed_tensor_content ], dim=0)
